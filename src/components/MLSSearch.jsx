...
const DEMO_LISTINGS = [
  ...
  { mlsId:'800008', listPrice:950000, listPrice:950000, listDate:'2026-06-01T00:00:00Z', remarks:'Stunning colonial in sought-after Pomona. Private cul-de-sac, custom kitchen.', photos:[], mls:{status:'Active'}, address:{streetNumber:'8',streetName:'Deer Run',city:'Pomona',state:'NY',postalCode:'10970'}, property:{bedrooms:5,bathsFull:3,area:3600,type:'Single Family',yearBuilt:2001,garageSpaces:2,pool:true}, agent:{firstName:'Eli',lastName:'Hoffman'}, office:{name:'KW Valley Realty'} },
]
