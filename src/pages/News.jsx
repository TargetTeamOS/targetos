  ...
  return (
    <div>
      <Grid4 style={{marginBottom:'14px'}}>
        <StatCard label="30yr Fixed"      value="7.25%"  sub="Up 0.12 this week"  subColor="#DC2626"/>
        <StatCard label="15yr Fixed"      value="6.75%"  sub="Stable"             subColor="#D97706"/>
        <StatCard label="Rockland Median" value="$648K"  sub="+4.2% year over year" subColor="var(--green)"/>
        <StatCard label="Days on Market"  value="28"     sub="Rockland average"    subColor="var(--teal)"/>
      </Grid4>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'14px'}}>
        ...
        <div>
          <Card style={{marginBottom:'13px'}}>
            ...
            {[['Active Listings','47','+3 this week','#0EA5E9'],['Pending Sales','31','High demand','#D97706'],['Sale/List Ratio','98.2%','Near asking','#16A34A'],['Inventory Months','1.8','Very low','#DC2626']].map(s=>(
          ...
          <Card>
            <CardHeader>Mortgage Rates</CardHeader>
