...
export function DailyBriefing() {
  ...
  return (
    <div style={{ fontFamily: ff }}>
      <PageHeader title="DailyBriefing" />
      <div style={{ background: 'var(--panel)', borderRadius: 'var(--radius)', border: '1px solid var(--border)', padding: '40px', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '16px', fontWeight: 700, color: 'var(--text)', marginBottom: '6px' }}>DailyBriefing — Coming Soon</div>
