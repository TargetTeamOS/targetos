...
const INIT_LISTINGS = [
  ...
  {addr:'20 Singer Ave',city:'Spring Valley',state:'NY',zip:'10977',price:1649000,type:'New Construction',beds:9,baths:'5.5',sqft:'4,357',tax:'New Home',status:'Active',agents:['Mendy Jankovits'],days:59,lock:'',mls:'',budget:4000,sellerName:'Singer Dev.',spend:[{c:'Photography',a:350,d:'Apr 17'},{c:'Luxury Ad',a:100,d:'May 1'}],showings:[],notes:''},
  {addr:'352 Blauvelt Rd Unit 201',city:'Monsey',state:'NY',zip:'10952',price:1149000,type:'New Construction',beds:5,baths:'4',sqft:'2,800',tax:'New Home',status:'Active',agents:['Isaac Leibowitz','Mendy Jankovits'],days:237,lock:'123',mls:'',budget:3000,sellerName:'',spend:[{c:'Photography',a:350,d:'Oct 22'}],showings:[],notes:''},
  {addr:'352 Blauvelt Rd Unit 203',city:'Monsey',state:'NY',zip:'10952',price:1149000,type:'New Construction',beds:5,baths:'4',sqft:'2,800',tax:'New Home',status:'Active',agents:['Isaac Leibowitz','Mendy Jankovits'],days:237,lock:'543',mls:'',budget:3000,sellerName:'',spend:[],showings:[],notes:''},
  {addr:'12 Sherman Drive #202',city:'Spring Valley',state:'NY',zip:'10977',price:1499000,type:'Condo',beds:5,baths:'4',sqft:'4,744',tax:'New Home',status:'Active',agents:['Joel Rottenstein'],days:127,lock:'1014',mls:'https://www.targetreteam.com/homes-for-sale/NY/spring-valley/10977/12-sherman-dr-unit-202/bid-38-961011',budget:5000,sellerName:'Developer LLC',spend:[{c:'Photography',a:350,d:'Feb 9'},{c:'Artistic Full-Page Ad',a:1350,d:'Feb 15'},{c:'Drone Footage',a:75,d:'Feb 9'},{c:'Floor Plans',a:65,d:'Feb 9'},{c:'Brochure',a:300,d:'Feb 20'},{c:'Mix Ad',a:40,d:'Mar 3'}],showings:[],notes:''},
  {addr:'11 Lincoln St #201',city:'Spring Valley',state:'NY',zip:'10977',price:1575000,type:'Condo',beds:8,baths:'6',sqft:'4,632',tax:'New Home',status:'Active',agents:['Mendy Jankovits'],days:46,lock:'',mls:'',budget:4000,sellerName:'',spend:[{c:'Photography',a:350,d:'Apr 30'},{c:'Luxury Ad',a:100,d:'May 5'}],showings:[],notes:''},
  {addr:'5 Mirror Lake Rd #201',city:'Spring Valley',state:'NY',zip:'10977',price:1599000,type:'Condo',beds:9,baths:'7',sqft:'4,777',tax:'New Home',status:'Active',agents:['Joel Rottenstein'],days:52,lock:'1014',mls:'',budget:4000,sellerName:'',spend:[],showings:[],notes:''},
  {addr:'1 Jade Lane',city:'Swan Lake',state:'NY',zip:'',price:299000,type:'Single Family',beds:3,baths:'2',sqft:'1,268',tax:'$6,132/yr',status:'Active',agents:['Joel Rottenstein'],days:63,lock:'',mls:'',budget:1500,sellerName:'',spend:[],showings:[],notes:''},
  {addr:'17 Union Rd #210',city:'Spring Valley',state:'NY',zip:'10977',price:979000,type:'Condo',beds:4,baths:'2.5',sqft:'',tax:'New Home',status:'Active',agents:['Eli Hoffman'],days:63,lock:'',mls:'',budget:2000,sellerName:'',spend:[],showings:[],notes:''},
  {addr:'135 Route 306 Unit 111',city:'Monsey',state:'NY',zip:'10952',price:639000,type:'Condo',beds:3,baths:'2',sqft:'1,215',tax:'$6,726/yr',status:'Accepted Offer',agents:['Lazer Farkas'],days:47,lock:'',mls:'',budget:2000,sellerName:'',spend:[{c:'Photography',a:350,d:'Apr 29'},{c:'Mix Ad',a:40,d:'May 5'}],showings:[],notes:''},
  {addr:'15 Warren Ct Unit #212',city:'Monsey',state:'NY',zip:'10952',price:1175000,type:'Condo',beds:5,baths:'4',sqft:'2,492',tax:'New Home',status:'Accepted Offer',agents:['Mendy Jankovits'],days:159,lock:'4152',mls:'',budget:3000,sellerName:'',spend:[],showings:[],notes:''},
  {addr:'8 First Street Unit 111',city:'Spring Valley',state:'NY',zip:'10977',price:749000,type:'Condo',beds:3,baths:'2',sqft:'1,205',tax:'New Home',status:'Accepted Offer',agents:['Mendy Jankovits'],days:49,lock:'',mls:'',budget:2000,sellerName:'',spend:[],showings:[],notes:''},
  {addr:'5 Pratt Street',city:'Haverstraw',state:'NY',zip:'10927',price:349000,type:'Single Family',beds:3,baths:'1',sqft:'1,020',tax:'$9,935/yr',status:'Accepted Offer',agents:['Avraham Weinberger'],days:152,lock:'',mls:'',budget:1500,sellerName:'',spend:[],showings:[],notes:''},
]
  ...
  if(selectedListing) {
    ...
    if(listing) return (
      <ListingDetail
        ...
        onEdit={()=>{setEditListing({...listing});setSelectedListing(null)}}
